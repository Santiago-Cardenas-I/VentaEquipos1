<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InformeVentas.aspx.cs" Inherits="GestionDeVentasEquipos.InformeVentas" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Menú Desplegable</title>
    <link rel="stylesheet" href="InformeVentas.css"/>
</head>
<body>
...
<div>
    <asp:DropDownList ID="ddlEstado" runat="server" Visible="false">
        ...
        <asp:ListItem Text="Pésimo" Value="Pesimo"/>
    </asp:DropDownList>
</div>
